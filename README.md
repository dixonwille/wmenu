# WMenu[![Pull Requests](https://github.com/dixonwille/wmenu/actions/workflows/pullRequests.yaml/badge.svg?event=push)](https://github.com/dixonwille/wmenu/actions/workflows/pullRequests.yaml)
