...
var (
	newMenuCases      = []string{"Testing this menu.", "", "!@#$%^&*()"}
	setSeperatorCases = []string{"", ".", ",", "~"}
	defaultIconCases  = []string{"", ",", "*", "~", "!", "@"}
	setTriesCases     = []int{0, -4, 5}
	optionCases       = []struct {
		name     string
		value    interface{}
		def      bool
